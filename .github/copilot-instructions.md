# Copilot instructions — SVG Grid Drawing Tool

Repository custom instructions for GitHub Copilot. Keep current as the project evolves.
(Same guidance as `copilot.md` / `CLAUDE.md` — one project, any assistant.)
